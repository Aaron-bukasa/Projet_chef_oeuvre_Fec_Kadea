    ...
    <div className="bg-bg_desktop">
      <div className="p-6 max-w-[1386px] mx-auto">
        ...
        <h1 className="font-bold text-center text-primary-blue text-3xl mb-6 pt-6 lg:mb-6 lg:text-center lg:text-3xl xl:text-4xl 2xl:text-5xl">
          ...
          <p className="text-center text-xl px-12">Que vous soyez un membre actuel, un futur membre ou un partenaire potentiel, nous sommes là pour vous.</p>
          <p className="text-xl px-12">Voici quelques raisons de nous contacter : En savoir plus sur les avantages de l'adhésion, Demander une adhésion, Poser des questions sur les partenariats, Obtenir de l'aide pour un problème lié à votre adhésion.</p>
        </div>
