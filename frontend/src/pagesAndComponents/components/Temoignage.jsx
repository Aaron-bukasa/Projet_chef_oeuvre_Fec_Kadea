export default function Temoignage({ className, text, imgTestim, name, statut }) {
    return (
      <div className={`${className} h-max w-full bg-white sm:max-w-[450px] sm:h-[485px] sm:flex sm:flex-col text-black p-6  rounded-xl lg:max-w-[420px] shadow-lg mx-auto xl:h-auto`}>
