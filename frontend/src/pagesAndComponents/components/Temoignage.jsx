export default function Temoignage({ className, text, imgTestim, name, statut }) {
    return (
      <div className={`${className} h-max w-full bg-white sm:max-w-[450px] sm:h-[450px] sm:flex sm:flex-col text-black p-6  rounded-xl md:relative lg:max-w-[420px] shadow-lg mx-auto xl:h-96`}>
        <div className="flex gap-x-3 items-center border-b-2 p-3 pb-4 lg:bottom-8">
          <div>
