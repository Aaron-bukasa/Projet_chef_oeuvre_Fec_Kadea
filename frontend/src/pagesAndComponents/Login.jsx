...
export default function Login({ setIsLogin }) {
  ...
  return (
    <div className="relative px-[10%] py-12 md:py-24 bg-bg_desktop 2xl:px-[13%] h-screen flex flex-col justify-center gap-y-3">
      <div className="w-full px-3 py-4 rounded-xl sm:mb-3 md:mb- max-w-[768px] mx-auto">
