...
export default function NavbarUtilisateur() {
  ...
  return (
    <div className={`${isClick ? 'h-screen grid grid-cols-2 grid-rows-[max-content,max-content,max-content]' : 'h-auto'} text-xl flex justify-between items-center p-6 lg:text-lg lg:items-center lg:justify-between xl:text-xl 2xl:px-44 bg-zinc-100 fixed top-0 z-[999] w-screen`}>
