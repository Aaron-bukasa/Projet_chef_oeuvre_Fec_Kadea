...
export default function FooterMember(props) {
          ...
          <ul className="flex flex-col gap-y-1">
            ...
            <li>
              <Link
                to="actuAnnonces"
                className={
                  props.currentPath === "/actuAnnonces"
            ...
            <li>
              <Link
                to="opportunites"
                className={
                  props.currentPath === "/opportunites"
                    ? "text-focus-color hover:text-focus-color lg:text-xl"
                    : "text-white hover:text-focus-color lg:text-xl"
                }
              >
            ...
            <li>
              <Link
                to="support"
                className={
                  props.currentPath === "/support"
                    ? "text-focus-color hover:text-focus-color lg:text-xl"
                    : "text-white hover:text-focus-color lg:text-xl"
                }
              >
                Support et défense des interets
              </Link>
            </li>
            <li>
              <Link
